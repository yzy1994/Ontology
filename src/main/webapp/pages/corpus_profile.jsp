				...
				<div id="article-content" class="article-content">
					<div>
						<div class="markdown_views">
							...
							<h3 id="事件的定义是什么">
								<a name="t2"></a>3、事件的定义是什么？
							</h3>

							<p>
								定义1(事件) 指在某个特定的时间和环境下发生的、由若干角色参与、表现出若干动作特征的一件事情。形式上,事件可表示为e,
								定义为一个六元组:e =(A , O , T, V , P , L) <br> 其中,
								事件六元组中的元素称为事件要素, 分别表示动作、对象、时间、环境、断言、语言表现。 <br>
								A(动作):事件的变化过程及其特征, 是对程度、方式、方法、工具等的描述, 例如快慢、使用什么、根据什么等等。 <br>
								O(对象):指事件的参与对象, 包括参与事件的所有角色,
								这些角色的类型数目称为对象序列长度。对象可分别是动作的施动者(主体)和受动者(客体)。 <br>
